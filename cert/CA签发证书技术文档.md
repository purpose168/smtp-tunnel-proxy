...
<table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%;">
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">单位名称: _________________________________________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">组织机构代码: ______________________________________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">法定代表人: _______________________________________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">联系人: __________________________________________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">联系电话: ________________________________________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">电子邮箱: ________________________________________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">通讯地址: ________________________________________</td>
  </tr>
</table>
...
<table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%;">
  ...
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">通用名称（CN）: _________________________________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">组织单位（OU）: _________________________________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">组织（O）: ____________________________________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">城市（L）: ______________________________________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">省/州（ST）: ____________________________________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">国家（C）: ______________________________________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">电子邮箱: ________________________________________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">有效期: □ 1年  □ 2年</td>
  </tr>
</table>
...
<table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%;">
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">证书用途说明:</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">_______________________________________________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">_______________________________________________</td>
  </tr>
...
<p>本人郑重声明：</p>
<ol>
  <li>所提供的信息真实、准确、完整</li>
  <li>证书将用于合法用途</li>
  <li>遵守证书策略（CP）和证书实践声明（CPS）</li>
  <li>承担因证书使用不当产生的法律责任</li>
</ol>
<p>申请人签字: _________________  日期: _________</p>

<h4>五、审核意见</h4>
<table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%;">
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">RA审核意见: _________________________________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">审核人签字: _________________  日期: _________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">CA审核意见: _________________________________</td>
  </tr>
  <tr>
    <td style="border: 1px solid #000; padding: 5px;">审核人签字: _________________  日期: _________</td>
  </tr>
